...
data ShakeOptions = ShakeOptions
    ...
    ,shakeInProcess :: Bool
        -- ^ Enables optimizations useful when Shake is being used as an in-process dependency graph (e.g. in ghcide)
...
fieldsShakeOptions =
    ...
    ,"shakeNeedDirectory", "shakeCanRedefineRules", "shakeInProcess"
